> [!summary]- Summary
> - Overview of MCP as a standardized protocol for LLM applications.
> - Clients and servers communicate via a client-server architecture.
> - Features include resources, tools, and prompts.
> - MCP supports various transport mechanisms like stdio and HTTP.
> - Debugging tools and best practices for integration are provided.
> - Community contributions and official implementations are available.
...
async def list_tools():
    return [{"name": "tool1", "description": "A sample tool"}]
