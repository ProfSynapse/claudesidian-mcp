...
import { MemoryQueryParams } from '../../../../types';
import { IGraphOperations, ILinkUtils } from '../interfaces';
 ...
 */
export class GraphOperations implements IGraphOperations {
    private linkUtils: ILinkUtils;
    
    constructor(linkUtils?: ILinkUtils) {
        this.linkUtils = linkUtils || new LinkUtils();
    }
