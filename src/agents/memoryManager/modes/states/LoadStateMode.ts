    ...
    private async createContinuationSession(
        ...
        try {
            ...
            const continuationData = {
                ...
                tags: [...(params.tags || []), 'restoration', 'state-loaded'],
                isActive: true,
                toolCalls: 0,
                startTime: Date.now()
            };
    ...
    private prepareFinalResult(stateData: any, contextResult: any, summaryResult: any, continuationSessionId?: string): StateResult {
        ...
        const resultData: any = {
            ...
            restoredContext: {
                ...
                stateCreatedAt: contextResult.stateCreatedAt,
                originalSessionId: stateSnapshot.sessionId,
                continuationHistory: summaryResult.continuationHistory,
                tags: contextResult.tags,
                activeTask: summaryResult.activeTask,
                activeFiles: summaryResult.activeFiles,
                nextSteps: summaryResult.nextSteps,
                reasoning: summaryResult.reasoning,
                restorationGoal: summaryResult.restorationGoal
            }
        };
    ...
    getParameterSchema(): any {
        return {
            ...
            properties: {
                ...
                sessionName: {
                    type: 'string',
                    description: 'Custom name for the new continuation session (optional)'
                },
                sessionDescription: {
                    type: 'string',
                    description: 'Custom description for the new continuation session (optional)'
                },
                restorationGoal: {
                    type: 'string',
                ...
                createContinuationSession: {
                    type: 'boolean',
                    description: 'Whether to automatically start a new session (default: true)'
                },
                tags: {
                    type: 'array',
                    items: { type: 'string' },
                    description: 'Tags to associate with the continuation session (optional)'
                }
            },
            required: ['stateId'],
