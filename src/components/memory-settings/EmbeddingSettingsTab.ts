 ...
 * Handles API configuration, embedding settings, content chunking, indexing schedules, performance settings, and filtering
 */
    ...
    async display(containerEl: HTMLElement): Promise<void> {
        ...
        if (currentProvider) {
            ...
            if (currentProvider.requiresApiKey) {
                ...
                // Ollama-specific settings with collapsible setup instructions using Accordion component
